...
if(~isempty(vizinhos))
   %%CALCULA OS CUSTOS F DE CADA MOVIMENTO POSSÍVEL%%
   ...
   %%ESCOLHE O MELHOR CUSTO COMO PRÓXIMO MOVIMENTO
...
%CASO NÃO EXISTAM MOVIMENTOS POSSÍVEIS   
else
%     disp('NÓ SEM SAÍDA');
...
%         disp('trocando o valor inicial');
        ...
        %%TESTA SE O ESTADO INICIAL ALEATÓRIO ESCOLHIDO JÁ FOI ESCOLHIDO
        %%ANTERIORMENTE!
        aux2 = 0;
        while(~aux2)
            aux = 0;
