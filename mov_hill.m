function vizinho = mov_hill(E_atual)
    [linha, coluna] = find(E_atual == 0);
    vizinho = {0};
    
    if(coluna > 1)                                                          %CONFERE SE � POSS�VEL MOVER PARA ESQUERDA
    ...
    if(coluna < 3)                                                          %CONFERE SE � POSS�VEL MOVER PARA DIREITA
    ...
    if(linha > 1)                                                          %CONFERE SE � POSS�VEL MOVER PARA CIMA
    ...
    if(linha < 3)                                                          %CONFERE SE � POSS�VEL MOVER PARA BAIXO
